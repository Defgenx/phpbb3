...
class client
{
	...
	{
		$json = file_get_contents($this->api_url . '/api/user/login');
		...
		return $this->api_url . '/api/user/login' . $response->exchange_key;
	}
    ...
    public function refresh() {
        ...
        $json = file_get_contents($this->api_url . '/api/auth/refresh_token/' . $keyarr[0]);
